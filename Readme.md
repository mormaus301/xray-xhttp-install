...
<br/>
UPD 24.04.2026:<br/>
Добавил блокировку RU доменов: (яндексы, вк, максы, рутубы, госуслуги, банки и т.д.), для того чтобы это обойти, и заходить со своим "родным" IP на RU сайты, скачиваем а затем выбираем в троне пессет Bypass Russia в разделе Routing. В v2rayNG на андроид есть аналогичные прессеты в разделе маршрутизация.<br/>
